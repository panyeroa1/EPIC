...
export const MOCK_PROJECTS: any[] = [
  { id: '1', name: 'Emerald Heights Plaza', status: 'Green', progress: 85, permits: true, indemnity: true, risk: 'Low', lastUpdate: '2024-05-20' },
  { id: '2', name: 'Vertex Corporate Tower', status: 'Yellow', progress: 45, permits: true, indemnity: false, risk: 'Medium', lastUpdate: '2024-05-22' },
  { id: '3', name: 'Azure Bay Residences', status: 'Red', progress: 12, permits: false, indemnity: false, risk: 'Critical', lastUpdate: '2024-05-23' },
  { id: '4', name: 'Nexus Logistics Hub', status: 'Green', progress: 92, permits: true, indemnity: true, risk: 'Low', lastUpdate: '2024-05-18' },
];
